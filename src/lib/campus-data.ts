...
export const campusLocations: CampusLocation[] = [
  ...
  { id: '11', name: 'B1', category: 'hostels', coordinates: { x: 10, y: 15 }, status: 'open' },
  { id: '12', name: 'B2', category: 'hostels', coordinates: { x: 5, y: 10 }, status: 'open' },
  { id: '13', name: 'B3', category: 'hostels', coordinates: { x: 3, y: 10 }, status: 'open' },
  { id: '14', name: 'B4', category: 'hostels', coordinates: { x: 4, y: 10 }, status: 'open' },
  { id: '15', name: 'B5', category: 'hostels', coordinates: { x: 5, y: 10 }, status: 'open' },
  { id: '16', name: 'B6', category: 'hostels', coordinates: { x: 6, y: 10 }, status: 'open' },
  { id: '17', name: 'B7', category: 'hostels', coordinates: { x: 7, y: 10 }, status: 'open' },
  { id: '18', name: 'B8', category: 'hostels', coordinates: { x: 8, y: 10 }, status: 'open' },
  { id: '19', name: 'G1', category: 'hostels', coordinates: { x: 9, y: 10 }, status: 'open' },
  { id: '20', name: 'G2', category: 'hostels', coordinates: { x: 10, y: 10 }, status: 'open' },
  { id: '21', name: 'G3', category: 'hostels', coordinates: { x: 11, y: 10 }, status: 'open' },
  { id: '22', name: 'G4', category: 'hostels', coordinates: { x: 12, y: 10 }, status: 'open' },
  { id: '23', name: 'G5', category: 'hostels', coordinates: { x: 13, y: 10 }, status: 'open' },
